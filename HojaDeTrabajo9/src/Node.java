...
public class Node<E> {
    ...
    public Association<String, String> getValue() {
         ...
         *
         * @return Association: vaor que contiene el nodo Key = palabra en
         * ingles value = palabra en español
    	*
         */
    ...
    public void setParent(Node newParent) {
         ...
         *
         * @param newParent nuevo padre del nodo post: re-parents this node to
